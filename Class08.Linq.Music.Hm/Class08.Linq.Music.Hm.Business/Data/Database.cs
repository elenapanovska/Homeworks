...
namespace Class08.Linq.Music.Hm.Business.Data
{
    public class Database
    {
        protected List<Person> FansList;
        ...
        public List<Person> FansData()
        {
            FansList = new List<Person>();
        ...
        public List<Song> SongsData()
        {
            ...
            Songs = new List<Song>() { song1, song2, song3, song4, song5, song6, song7,song8, song9,
                                       song10, song11, song12, song13, song14,song15, song16, song17,
                                       song18,song19, song20, song21, song22, song23, song24, song25,
